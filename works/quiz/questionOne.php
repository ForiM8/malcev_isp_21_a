            ...
            echo'<div class="main__container">';
                ...
                foreach($result as $row){
                    ...
                    echo'<div class="main__container__question">;';
                        echo'<div class="main__container__question-countQuestion">Вопрос 1 из 10</div>';
                    ...
                    echo'<div class="main__cintainer__button">';
                        ...
                        if($row["answer"] == 0)echo'<div class="main__cintainer__button-question">'. $row["question_3"] .'</div>';
                    echo'</div>';
                }
            echo'</div>';
        echo'</div>';
